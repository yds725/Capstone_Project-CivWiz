...
export default class Scrambled extends Component {
  ...
  newWord() {
	...
	const indvWords = currentWord.split(' ')
    const count = indvWords.length
    let scrambledWord = ''
    let newscrambledWord = []

    for(let n=0; n < count; n++){
      newscrambledWord[n] = g.scramble(indvWords[n])
      scrambledWord = scrambledWord + newscrambledWord[n] + ' '
    }
